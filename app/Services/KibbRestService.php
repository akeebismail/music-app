...
class KibbRestService {
     ...
     */
    protected $_endpoint;
    /** The Guzzle Client to talk to api.
     * @var string
     */
    protected $_client;
    ...
    public function request($verb, $uri, $appendKey = true, array $params = [])
    {
        try {
            ...
            if ($this->_respondFormat === 'json') {
                return json_decode($body);
            }

            if ($this->_respondFormat === 'xml') {
     ...
     * @return string
     */
    public function getKeyParam(): string
    {
